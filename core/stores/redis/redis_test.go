...
func TestRedis_Exists(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Exists("a")
		assert.NotNil(t, err)
...
func TestRedis_Eval(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Eval(`redis.call("EXISTS", KEYS[1])`, []string{"notexist"})
		assert.NotNil(t, err)
...
func TestRedis_Hgetall(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		_, err := NewRedis(client.Addr, "", 0).Hgetall("a")
		assert.NotNil(t, err)
...
func TestRedis_Hvals(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.NotNil(t, NewRedis(client.Addr, "", 0).Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "bb", "bbb"))
		_, err := NewRedis(client.Addr, "", 0).Hvals("a")
		assert.NotNil(t, err)
...
func TestRedis_Hsetnx(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.Nil(t, client.Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "bb", "bbb"))
		_, err := NewRedis(client.Addr, "", 0).Hsetnx("a", "bb", "ccc")
		assert.NotNil(t, err)
...
func TestRedis_HdelHlen(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.Nil(t, client.Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "bb", "bbb"))
		_, err := NewRedis(client.Addr, "", 0).Hlen("a")
		assert.NotNil(t, err)
...
func TestRedis_HIncrBy(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Hincrby("key", "field", 2)
		assert.NotNil(t, err)
...
func TestRedis_Hkeys(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.Nil(t, client.Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "bb", "bbb"))
		_, err := NewRedis(client.Addr, "", 0).Hkeys("a")
		assert.NotNil(t, err)
...
func TestRedis_Hmget(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.Nil(t, client.Hset("a", "aa", "aaa"))
		assert.Nil(t, client.Hset("a", "bb", "bbb"))
		_, err := NewRedis(client.Addr, "", 0).Hmget("a", "aa", "bb")
		assert.NotNil(t, err)
...
func TestRedis_Hmset(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.NotNil(t, NewRedis(client.Addr, "", 0).Hmset("a", nil))
...
func TestRedis_Hscan(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		sum := 0
		for {
			_, _, err := NewRedis(client.Addr, "", 0).Hscan(key, cursor, "*", 100)
			assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).Del(key)
		assert.NotNil(t, err)
...
func TestRedis_Incr(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Incr("a")
		assert.NotNil(t, err)
...
func TestRedis_IncrBy(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Incrby("a", 2)
		assert.NotNil(t, err)
...
func TestRedis_Keys(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Keys("*")
		assert.NotNil(t, err)
...
func TestRedis_List(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Lpush("key", "value1", "value2")
		assert.NotNil(t, err)
		val, err := client.Lpush("key", "value1", "value2")
		assert.Nil(t, err)
		assert.Equal(t, 2, val)
		_, err = NewRedis(client.Addr, "", 0).Rpush("key", "value3", "value4")
		assert.NotNil(t, err)
		val, err = client.Rpush("key", "value3", "value4")
		assert.Nil(t, err)
		assert.Equal(t, 4, val)
		_, err = NewRedis(client.Addr, "", 0).Llen("key")
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).Lpop("key")
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.Equal(t, 5, val)
		_, err = NewRedis(client.Addr, "", 0).Rpop("key")
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).Lrem("key", 2, "value1")
		assert.NotNil(t, err)
		n, err := client.Lrem("key", 2, "value1")
		assert.Nil(t, err)
		assert.Equal(t, 2, n)
		_, err = NewRedis(client.Addr, "", 0).Lrange("key", 0, 10)
		assert.NotNil(t, err)
		vals, err = client.Lrange("key", 0, 10)
		assert.Nil(t, err)
...
func TestRedis_Mget(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		err = client.Set("key2", "value2")
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Mget("key1", "key0", "key2", "key3")
		assert.NotNil(t, err)
...
func TestRedis_SetBit(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := NewRedis(client.Addr, "", 0).SetBit("key", 1, 1)
		assert.NotNil(t, err)
...
func TestRedis_GetBit(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).GetBit("key", 2)
		assert.NotNil(t, err)
...
func TestRedis_BitCount(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		_, err := NewRedis(client.Addr, "", 0).BitCount("key", 0, -1)
		assert.NotNil(t, err)
...
func TestRedis_BitOpAnd(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).BitOpAnd("destKey", "key1", "key2")
		assert.NotNil(t, err)
...
func TestRedis_BitOpNot(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := client.Set("key1", "\u0000")
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).BitOpNot("destKey", "key1")
		assert.NotNil(t, err)
...
func TestRedis_BitOpOr(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).BitOpOr("destKey", "key1", "key2")
		assert.NotNil(t, err)
...
func TestRedis_BitOpXor(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).BitOpXor("destKey", "key1", "key2")
		assert.NotNil(t, err)
...
func TestRedis_BitPos(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		_, err = NewRedis(client.Addr, "", 0).BitPos("key", 0, 0, -1)
		assert.NotNil(t, err)
...
func TestRedis_Persist(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Persist("key")
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.False(t, ok)
		err = NewRedis(client.Addr, "", 0).Expire("key", 5)
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.True(t, ok)
		err = NewRedis(client.Addr, "", 0).Expireat("key", time.Now().Unix()+5)
		assert.NotNil(t, err)
...
func TestRedis_Scan(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		err = client.Set("key2", "value2")
		assert.Nil(t, err)
		_, _, err = NewRedis(client.Addr, "", 0).Scan(0, "*", 100)
		assert.NotNil(t, err)
...
func TestRedis_Sscan(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		sum := 0
		for {
			_, _, err := NewRedis(client.Addr, "", 0).Sscan(key, cursor, "", 100)
			assert.NotNil(t, err)
...
func TestRedis_Set(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := NewRedis(client.Addr, "", 0).Sadd("key", 1, 2, 3, 4)
		assert.NotNil(t, err)
		num, err := client.Sadd("key", 1, 2, 3, 4)
		assert.Nil(t, err)
		assert.Equal(t, 4, num)
		_, err = NewRedis(client.Addr, "", 0).Scard("key")
		assert.NotNil(t, err)
		val, err := client.Scard("key")
		assert.Nil(t, err)
		assert.Equal(t, int64(4), val)
		_, err = NewRedis(client.Addr, "", 0).Sismember("key", 2)
		assert.NotNil(t, err)
		ok, err := client.Sismember("key", 2)
		assert.Nil(t, err)
		assert.True(t, ok)
		_, err = NewRedis(client.Addr, "", 0).Srem("key", 3, 4)
		assert.NotNil(t, err)
		num, err = client.Srem("key", 3, 4)
		assert.Nil(t, err)
		assert.Equal(t, 2, num)
		_, err = NewRedis(client.Addr, "", 0).Smembers("key")
		assert.NotNil(t, err)
		vals, err := client.Smembers("key")
		assert.Nil(t, err)
		assert.ElementsMatch(t, []string{"1", "2"}, vals)
		_, err = NewRedis(client.Addr, "", 0).Srandmember("key", 1)
		assert.NotNil(t, err)
		members, err := client.Srandmember("key", 1)
		assert.Nil(t, err)
		assert.Len(t, members, 1)
		assert.Contains(t, []string{"1", "2"}, members[0])
		_, err = NewRedis(client.Addr, "", 0).Spop("key")
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).Sadd("key1", 1, 2, 3, 4)
		assert.NotNil(t, err)
...
func TestRedis_SetGetDel(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := NewRedis(client.Addr, "", 0).Set("hello", "world")
		assert.NotNil(t, err)
		err = client.Set("hello", "world")
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Get("hello")
		assert.NotNil(t, err)
...
func TestRedis_SetExNx(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := NewRedis(client.Addr, "", 0).Setex("hello", "world", 5)
		assert.NotNil(t, err)
		err = client.Setex("hello", "world", 5)
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Setnx("hello", "newworld")
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.True(t, ttl > 0)
		_, err = NewRedis(client.Addr, "", 0).SetnxEx("newhello", "newworld", 5)
		assert.NotNil(t, err)
...
func TestRedis_SetGetDelHashField(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Hget("key", "field")
		assert.NotNil(t, err)
		val, err := client.Hget("key", "field")
		assert.Nil(t, err)
		assert.Equal(t, "value", val)
		_, err = NewRedis(client.Addr, "", 0).Hexists("key", "field")
		assert.NotNil(t, err)
		ok, err := client.Hexists("key", "field")
		assert.Nil(t, err)
		assert.True(t, ok)
		_, err = NewRedis(client.Addr, "", 0).Hdel("key", "field")
		assert.NotNil(t, err)
...
func TestRedis_SortedSet(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		...
		assert.Nil(t, err)
		assert.Equal(t, int64(2), val)
		_, err = NewRedis(client.Addr, "", 0).Zincrby("key", 3, "value1")
		assert.NotNil(t, err)
		val, err = client.Zincrby("key", 3, "value1")
		assert.Nil(t, err)
		assert.Equal(t, int64(5), val)
		_, err = NewRedis(client.Addr, "", 0).Zscore("key", "value1")
		assert.NotNil(t, err)
		val, err = client.Zscore("key", "value1")
		assert.Nil(t, err)
		assert.Equal(t, int64(5), val)
		_, err = NewRedis(client.Addr, "", 0).Zadds("key")
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.Equal(t, int64(2), val)
		_, err = NewRedis(client.Addr, "", 0).ZRevRangeWithScores("key", 1, 3)
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).Zrank("key", "value4")
		assert.NotNil(t, err)
		_, err = client.Zrank("key", "value4")
		assert.Equal(t, Nil, err)
		_, err = NewRedis(client.Addr, "", 0).Zrem("key", "value2", "value3")
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.True(t, ok)
		_, err = NewRedis(client.Addr, "", 0).Zremrangebyscore("key", 6, 7)
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.True(t, ok)
		_, err = NewRedis(client.Addr, "", 0).Zadd("key", 7, "value3")
		assert.NotNil(t, err)
		ok, err = client.Zadd("key", 7, "value3")
		assert.Nil(t, err)
		assert.True(t, ok)
		_, err = NewRedis(client.Addr, "", 0).Zcount("key", 6, 7)
		assert.NotNil(t, err)
		num, err = client.Zcount("key", 6, 7)
		assert.Nil(t, err)
		assert.Equal(t, 2, num)
		_, err = NewRedis(client.Addr, "", 0).Zremrangebyrank("key", 1, 2)
		assert.NotNil(t, err)
		num, err = client.Zremrangebyrank("key", 1, 2)
		assert.Nil(t, err)
		assert.Equal(t, 2, num)
		_, err = NewRedis(client.Addr, "", 0).Zcard("key")
		assert.NotNil(t, err)
		card, err := client.Zcard("key")
		assert.Nil(t, err)
		assert.Equal(t, 2, card)
		_, err = NewRedis(client.Addr, "", 0).Zrange("key", 0, -1)
		assert.NotNil(t, err)
		vals, err := client.Zrange("key", 0, -1)
		assert.Nil(t, err)
		assert.EqualValues(t, []string{"value1", "value4"}, vals)
		_, err = NewRedis(client.Addr, "", 0).Zrevrange("key", 0, -1)
		assert.NotNil(t, err)
		vals, err = client.Zrevrange("key", 0, -1)
		assert.Nil(t, err)
		assert.EqualValues(t, []string{"value4", "value1"}, vals)
		_, err = NewRedis(client.Addr, "", 0).ZrangeWithScores("key", 0, -1)
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).ZrangebyscoreWithScores("key", 5, 8)
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).ZrangebyscoreWithScoresAndLimit(
			"key", 5, 8, 1, 1)
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).ZrevrangebyscoreWithScores("key", 5, 8)
		assert.NotNil(t, err)
		...
		_, err = NewRedis(client.Addr, "", 0).ZrevrangebyscoreWithScoresAndLimit(
			"key", 5, 8, 1, 1)
		assert.NotNil(t, err)
		...
		assert.Nil(t, err)
		assert.Equal(t, 0, len(pairs))
		_, err = NewRedis(client.Addr, "", 0).Zrevrank("key", "value")
		assert.NotNil(t, err)
...
func TestRedis_Pipelined(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		assert.NotNil(t, NewRedis(client.Addr, "", 0).Pipelined(func(pipeliner Pipeliner) error {
			return nil
		}))
		...
		assert.Nil(t, err)
		_, err = NewRedis(client.Addr, "", 0).Ttl("pipelined_counter")
		assert.NotNil(t, err)
...
func TestRedisString(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		client.Ping()
		_, err := getRedis(NewRedis(client.Addr, ClusterType, 0))
		assert.Nil(t, err)
		assert.Equal(t, client.Addr, client.String())
		assert.NotNil(t, NewRedis(client.Addr, "", 0).Ping())
	})
}
...
func TestRedisScriptLoad(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		client.Ping()
		_, err := NewRedis(client.Addr, "", 0).ScriptLoad("foo")
		assert.NotNil(t, err)
